package io.github.s0ooo0k.day49.controller;

import io.github.s0ooo0k.day49.model.vo.KeywordSearch;
import io.github.s0ooo0k.day49.service.BookmarkService;
...
public class MainController {
    ...
    public String bookmark(@RequestParam("uuid") String uuid, Model model, HttpSession session) throws Exception {
        ...
        return "redirect:/bookmarkList"; // servlet으로 보내기
    }

    @GetMapping("/bookmarkList")
    public String bookmarList(Model model) {
        List<KeywordSearch> bookmarks = bookmarkService.getAllBookmarks();
